...
undergradList = pd.read_excel (r'Admins.xlsx', sheet_name='Sheet1');
...
for i in range(0, undergradList.shape[0]):
    ...
    if(undergradList.iloc[[i]].gender.item=='Female'):
        gender='0'
    elif(undergradList.iloc[[i]].gender.item=='Male'):
        gender='1'
    else:
        gender = '3';
    ...
    data = {
            	...
            	"password": undergradList.iloc[[i]].last_name.item() + str(undergradList.iloc[[i]].ID.item()),
