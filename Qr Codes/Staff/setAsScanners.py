...
URL = "http://fye-em.aui.ma/automations/r6eDP2EAvoVMgQJobV7L/events/EVENTByEY7A0ML9ENb4jgnzLZ/steps/STEPkr1YQAaq581wLJQA2RJw/privilege/scanner/"


list = pd.read_excel (r'Mentors.xlsx', sheet_name='Sheet1');
